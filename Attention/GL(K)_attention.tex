...
\coordinate (C2) at (2.0,-0.25);
\coordinate (C3) at (3.6,-0.15);
\coordinate (C4) at (5.2,0.00);
\coordinate (C5) at (6.8,0.15);
\coordinate (C6) at (8.2,0.25);
...
\filldraw[neighborred, opacity=0.12, draw=neighborred!60,
          line width=0.5pt, densely dashed]
  (6.2,-0.20) ellipse (2.7 and 0.52);
\node[neighborred!80!black, font=\scriptsize] at (8.2,0.0) {$\mathcal{U}_j$};
