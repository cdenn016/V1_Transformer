...
\begin{theorem}[Conditional CLT contraction of the gauge VFE family]
...
The empirical content of the original conjecture---the application of these scaling dimensions to the learned representations of trained transformers, where the i.i.d.\ assumption is not known to hold---is logically separate from Theorem~\ref{thm:rg_conditional} and remains an open conjecture.
