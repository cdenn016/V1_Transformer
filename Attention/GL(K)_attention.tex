...
The three-limit reduction to standard attention can be understood as a renormalization group (RG) flow in which coarse-graining drives the gauge VFE couplings toward the transformer fixed point. We conjecture that the standard transformer occupies a stable infrared fixed point with scaling dimensions $y_1 = -1/2$ (anisotropy), $y_2 = -1$ (gauge variation), $y_3 = -2$ (holonomy), all irrelevant. The full conjecture, testable predictions, and numerical validation on a synthetic VFE system are presented in Supplementary Appendix~F.
