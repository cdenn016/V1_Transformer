...
The multi-model validation (Table~\ref{tab:multi_model}) reveals a $0.24$ spread in grand-mean correlation across architectures that all share $d_{\text{head}} = 64$. If the temperature prediction $\tau \approx 2\sqrt{d_{\text{head}}}$ were the sole determinant of the $\alpha$--$\beta$ correspondence, all five models would achieve similar correlations at $\tau = 19.0$. The observed variation, with RoBERTa at $\bar{r} = 0.612$ and ALBERT at $\bar{r} = 0.851$, demands explanation.
