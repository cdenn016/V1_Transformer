...
% Drawn as semi-transparent filled ellipses on the surface
% =====================================================================

% U_i: agent i's local open set (left-center region)
\filldraw[neighborblue, opacity=0.12, draw=neighborblue!60,
          line width=0.5pt, densely dashed]
  (2.8,-0.45) ellipse (2.6 and 0.55);
\node[neighborblue!80!black, font=\scriptsize] at (1.0,-0.10) {$\mathcal{U}_i$};

% U_j: agent j's local open set (center-right region)
\filldraw[neighborred, opacity=0.12, draw=neighborred!60,
          line width=0.5pt, densely dashed]
  (6.0,-0.25) ellipse (2.8 and 0.55);
\node[neighborred!80!black, font=\scriptsize] at (8.0,-0.0) {$\mathcal{U}_j$};
...
% belief in the fiber over EACH point c. Using plot[smooth] for
% genuinely smooth interpolation through waypoints.
% =====================================================================

% --- Section q_i (blue, solid) — smooth curve via plot ---
...
% --- Section q_j (red, dashed) — smooth curve via plot ---
\coordinate (Sj1) at ($(C1)+(0,3.6)$);
\coordinate (Sj2) at ($(C2)+(0,3.3)$);
\coordinate (Sj3) at ($(C3)+(0,3.8)$);
\coordinate (Sj4) at ($(C4)+(0,4.2)$);
\coordinate (Sj5) at ($(C5)+(0,3.8)$);
...
% =====================================================================
% HIGHLIGHT FIBER AT c* — the fourth fiber (C4), in the overlap U_i∩U_j
%
...
with local open neighborhoods $\mathcal{U}_i$ (blue) and $\mathcal{U}_j$ (red)
shown as overlapping regions; each agent's section is defined over its own patch.
Vertical dashed lines are belief fibers $\mathcal{B}_q \cong \mathbb{R}^K$.
Agents $i$ and $j$ define smooth sections
$c \mapsto q_i(c)$ (solid blue) and $c \mapsto q_j(c)$ (dashed red),
each assigning a Gaussian belief in the fiber over every point in its domain.
