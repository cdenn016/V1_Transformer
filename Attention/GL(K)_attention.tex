...
\textbf{Note on appendix structure.} Standard differential geometry, covariance dynamics, gauge frame gradient derivations, and numerical method details are provided in the Supplementary Material (Appendices~A--D). The BERT validation, Bayesian uncertainty quantification, RG universality conjecture and numerical validation, and symmetry breaking simulations are also in the Supplementary Material (Appendices~E--G). Appendix~A below establishes the conditional uniqueness of the forward KL divergence.
...
% Symmetry Breaking Simulations and Model-Channel Formalism moved to Supplementary Appendix G
