...
This conjecture involves three logically distinct claims: that the bulk of semantic transport between contexts is path-independent; that communicative systems face functional pressure toward path-independence (since meaning that depends on the relay path degrades reliable communication); and that transformers succeed in part because their flat bundle structure matches this property of language. We regard the first and third claims as substantive and testable; the second is a plausibility argument, not a derivation.
