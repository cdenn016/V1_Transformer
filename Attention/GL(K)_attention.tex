...
\textbf{Conjecture (flat bundle optimality).} \emph{Natural language, as an informational system, has evolved toward minimal holonomy: that is, the semantic transport between contexts is approximately path-independent.} Transformers succeed not despite their restriction to flat bundles, but because of it: they are architecturally matched to the geometric structure that language has already converged to.
