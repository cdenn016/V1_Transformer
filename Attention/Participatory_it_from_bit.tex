...
This position is closest in spirit to information-geometric structuralism: the underlying reality of which both physics and experience are aspects is the gauge-theoretic information geometry of the framework. It has affinities with Russell's neutral monism~\cite{Russell1927} and with Chalmers' later explorations of panpsychism~\cite{Chalmers2013consciousness}, but it does not require either: it commits only to taking information geometry as the substrate from which both physical and phenomenal description are observer-dependent pullbacks.
...
Two honest divergences should be noted. Lahav and Neemeh's account is positioned as physicalist with relational/measurement-theoretic flavour, with the underlying reality of which the two perspectives are ``two sides'' left ontologically thin. The construction here makes a stronger commitment: the underlying reality is information geometry on principal bundles, with both phenomenal experience and what we call physical structure arising as observer-dependent pullbacks from this substrate. This is closer to neutral monism than to physicalism, and the resulting account of qualia in the preceding subsection differs accordingly. Likewise, the relativistic analogy in Lahav and Neemeh proceeds without an analogue of the speed of light --- without the second postulate that uniquely fixes the Lorentz group in special relativity. The present framework does not supply such a second postulate either; what it offers instead is a mechanism, the Yang-Mills kinetic term acting on $\mathrm{GL}(K, \mathbb{C})$ gauge frames, by which Lorentz signature might emerge dynamically rather than be assumed. Whether either route reaches a fully Einsteinian rather than Galilean theory of cognitive frames remains open.
