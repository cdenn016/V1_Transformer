...
def build_killing_form_preconditioner(
    ...
    # Invert to get natural gradient metric.  _safe_spd_inv uses Cholesky
    # primary + escalating-jitter fallback, more stable than raw inv for
    # ill-conditioned Killing/Cartan metrics (the metric is a sum of outer
    # products of phi gradients, SPD by construction but can be
    # numerically rank-deficient at init or after large phi updates).
