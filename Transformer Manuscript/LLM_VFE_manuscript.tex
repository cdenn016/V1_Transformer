...
The gauge VFE framework also admits deep connections to information bottleneck theory and renormalization group methods from physics; we develop these theoretical correspondences in Appendix~\ref{app:theoretical_connections}.
