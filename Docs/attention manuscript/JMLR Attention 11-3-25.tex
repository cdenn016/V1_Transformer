...
The alignment term $D_{\mathrm{KL}}(q_i \,\|\, \Omega_{ij} q_j)$ involves KL divergences between Gaussians related by $\mathrm{GL}(K)$ gauge transport $\Omega_{ij} = e^{\phi_i}e^{-\phi_j}$. The standard Gaussian KL divergence is
