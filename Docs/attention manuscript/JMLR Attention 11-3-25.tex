...
We validate the full theory by training a $\mathrm{GL}(30)$ gauge transformer on WikiText-103 using only KL divergences, geometry, and gauge transport without any learned attention projections, MLPs, or activation functions. The resulting transformer achieves test perplexity $\sim$125 with emergent semantic structure in the learned gauge frames and beliefs.
\end{abstract}
