...
We have shown that the machine learning attention mechanism and backpropagation have a natural explanation as the limit of natural gradient descent on our gauge-equivariant free energy principle. Most remarkably, our framework predicts exponential speedup of training compared to standard backpropagation---a major bottleneck in modern AI architectures that currently requires enormous energy expenditure to train the most powerful platforms.
